...
import stripe
stripe.api_key = "sk_test_aGVY1QHtnjASVW8t3riP2soE"
...
#   currency = "usd",
#   customer =  BillingProfile.objects.filter(email='intro@teamcfe.com').first().stripe_id,
#   source = Card.objects.filter(billing_profile__email='intro@teamcfe.com').first().stripe_id, # obtained with Stripe.js
