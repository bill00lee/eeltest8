...
urlpatterns = [
    url(r'^$', intro.views.home_page, name='home_page'),
    url(r'^about_page/$', intro.views.about_page, name= 'about_page'),
    url(r'^contact/$', intro.views.contact_page, name='contact_url'),
